...
create sequence sftm.seq_log
start with 1 increment by 1 no minvalue no maxvalue cache 1;

create table sftm.tb_log (
 id bigint default nextval('sftm.seq_log'::regclass) not null
 ,gubun character varying(10)
 ,tr_name character varying(100)
...
alter sequence  sftm.seq_log owned by sftm.tb_log.id;
alter table  sftm.tb_log owner to sftm_admin;
alter table  sftm.tb_log add primary key(id);
